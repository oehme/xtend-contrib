...
public class JnarioCompilerClient {

	private ZincClient zinc = new ZincClient(JnarioCompilerServer.DEFAULT_PORT);

	public boolean compile(List<String> args) {
		return zinc.send("jnario", 
	...
	private void startServer(String classpath) {
		JnarioCompilerServer.fork(classpath);
		int count = 0;
